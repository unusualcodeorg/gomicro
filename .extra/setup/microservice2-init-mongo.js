...
seed("microservice2-prod-db", "microservice2-prod-db-user", "changeit");
seed("microservice2-dev-db", "microservice2-dev-db-user", "changeit");
seed("microservice2-test-db", "microservice2-test-db-user", "changeit");
