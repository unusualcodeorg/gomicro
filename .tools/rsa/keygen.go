...
func main() {
	...
	err = savePrivateKeyToFile(privateKey, "auth_service/keys/private.pem")
	if err != nil {
	...
	err = savePublicKeyToFile(&privateKey.PublicKey, "auth_service/keys/public.pem")
	if err != nil {
		fmt.Println("Error saving public key:", err)
		return
	}

	fmt.Println("RSA key pair generated and saved to auth_service/keys/private.pem and auth_service/keys/public.pem")
}
